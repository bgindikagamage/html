...
class NegotiableQuoteItemManagementTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testUpdateQuoteItemsCustomPrices(
        ...
        $quoteTotals->expects($this->exactly($originalSubtotalCalls+1))
            ->method('getCatalogTotalPrice')->willReturn($originalPrice);
    ...
    public function testSetNegotiableQuotePricesWithQuoteStatusCreated()
    {
        ...
        $quoteNegotiation->expects($this->once())->method('getStatus')
    ...
    public function testRecalculateOriginalPriceTax(
        ...
        $quoteTotals->expects($this->exactly(2))
            ->method('getCatalogTotalPrice')->willReturn($originalPrice);
        $quoteTotals->expects($this->exactly(2))
            ->method('getSubtotal')->willReturn($originalPrice);
     ...
     * @return array
     */
    private function mockQuoteItem($quoteItemId)
    {
