...
class ExpirationTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @return void
     */
    public function testGetExpirationPeriodTime($time, $status, $expect)
    {
    ...
    public function expirationPeriodDataDataProvider()
    {
        ...
        return [
            [$date->format('c'), NegotiableQuoteInterface::STATUS_CREATED, $date],
            [null, NegotiableQuoteInterface::STATUS_CREATED, $date]
        ];
    }
