...
class TotalsTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->extensionAttributes = $this->getMockBuilder(\Magento\Quote\Api\Data\CartItemExtensionInterface::class)
            ->setMethods(['getNegotiableQuoteItem', 'getNegotiableQuote'])
            ->disableOriginalConstructor()->getMockForAbstractClass();
    ...
    public function testGetQuoteVisibleItems()
    {
        ...
        $cartItemExtensionMock = $this->getMockBuilder(\Magento\Quote\Api\Data\CartItemExtension::class)
            ...
            ->disableOriginalConstructor()->getMock();
        $this->extensionFactory->expects($this->once())->method('create')
            ->willReturn($cartItemExtensionMock);
        $cartItemExtensionMock->expects($this->once())->method('setNegotiableQuoteItem')
            ->with($negotiableQuoteItemMock)->willReturnSelf();
        $this->quoteItemModelMock->expects($this->any())->method('setExtensionAttributes')
    ...
    public function getSubtotalDataProvider()
    {
        return [
            [
                false, false, true, false, 20, 15, 160, [
                    'getSubtotalWithDiscount' => 0, 'getBaseSubtotalWithDiscount' => 1,
                    'shipping' => [
                        'getShippingAddress' => 0, 'getBaseShippingTaxAmount' => 0, 'getBaseTaxAmount' => 0,
                        'getTaxAmount' => 0, 'getShippingTaxAmount' => 0,
                    ],
            ...
            [
                false, true, true, true, 20, 15, 175, [
                    'getSubtotalWithDiscount' => 0, 'getBaseSubtotalWithDiscount' => 1,
                    'shipping' => [
                        'getShippingAddress' => 0, 'getBaseShippingTaxAmount' => 0, 'getBaseTaxAmount' => 0,
                        'getTaxAmount' => 0, 'getShippingTaxAmount' => 0
            ...
            [
                false, true, false, true, 20, 15, 159, [
                    'getSubtotalWithDiscount' => 0, 'getBaseSubtotalWithDiscount' => 1,
                    'shipping' => [
                        'getShippingAddress' => 2, 'getBaseShippingTaxAmount' => 1, 'getBaseTaxAmount' => 1,
                        'getTaxAmount' => 0, 'getShippingTaxAmount' => 0
                    ],
                    'billing' => [
                        'getBaseTaxAmountBilling' => 0,
            ...
            [
                true, false, true, false, 20, 15, 130, [
                    'getSubtotalWithDiscount' => 1, 'getBaseSubtotalWithDiscount' => 0,
                    'shipping' => [
                        'getShippingAddress' => 0, 'getBaseShippingTaxAmount' => 0, 'getBaseTaxAmount' => 0,
                        'getTaxAmount' => 0, 'getShippingTaxAmount' => 0
                    ],
