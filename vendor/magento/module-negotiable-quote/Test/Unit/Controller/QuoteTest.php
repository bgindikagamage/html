...
class QuoteTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @return void
     */
    public function testDispatchWithFlagNoDispatch()
    {
        $this->settingsProvider->expects($this->once())->method('isModuleEnabled')->willReturn(true);
        $this->settingsProvider->expects($this->once())
            ->method('getCurrentUserType')
     ...
     * @return void
     */
    public function testDispatchWithDisabledQuote($isCurrentUserCompanyUser, $redirectPath)
    {
        $this->settingsProvider->expects($this->once())->method('isModuleEnabled')->willReturn(true);
        $this->settingsProvider->expects($this->once())
            ->method('getCurrentUserType')
        ...
        $this->redirect->expects($this->once())->method('redirect')->with($this->response, $redirectPath, []);
     ...
     * @return array
     */
    public function dispatchWithDisabledQuoteDataProvider()
    {
        return [
