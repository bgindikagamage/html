...
class NegotiableQuoteRecalculateTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @param \PHPUnit_Framework_MockObject_Matcher_Invocation $recalculateExpected
     * @param string $recalculateMethod
     * @param int $price
     * @param \PHPUnit_Framework_MockObject_Matcher_Invocation $validateExpected
     * @return void
    ...
    public function testSave(
        $quoteId,
        $newData,
        \PHPUnit_Framework_MockObject_Matcher_Invocation $recalculateExpected,
        $recalculateMethod,
        $price,
        \PHPUnit_Framework_MockObject_Matcher_Invocation $validateExpected
    ) {
