 ...
 */
class ShippingMethod extends \Magento\NegotiableQuote\Controller\Adminhtml\Quote
{
    /**
     * @var RawFactory
     */
    ...
    public function execute()
    {
        ...
        if ($quote) {
            try {
                ...
                $this->messageManager->addErrorMessage(__('Exception occurred during quote view %s', $e->getMessage()));
            }
        }
