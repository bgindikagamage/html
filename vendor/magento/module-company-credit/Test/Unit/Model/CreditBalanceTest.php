...
class CreditBalanceTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @exceptionMessage The requested Payment Method is not available.
     */
     ...
     * @return void
     * @expectedException \Magento\Framework\Exception\LocalizedException
     * @exceptionMessage Payment On Account cannot be used for this order because your order amount exceeds your
     * credit amount.
     */
