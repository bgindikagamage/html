...
class AfterCompanySaveObserverTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @param \PHPUnit_Framework_MockObject_Matcher_InvokedCount $invokesMatched
     * @param \PHPUnit_Framework_MockObject_Matcher_InvokedCount $saveInvoked
    ...
    public function testExecute(
        ...
        $code,
        $rate,
        \PHPUnit_Framework_MockObject_Matcher_InvokedCount $invokesMatched,
        \PHPUnit_Framework_MockObject_Matcher_InvokedCount $saveInvoked
    ) {
        $creditLimitId = 1;
