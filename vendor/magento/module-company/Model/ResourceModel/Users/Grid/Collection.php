...
class Collection extends \Magento\Customer\Model\ResourceModel\Grid\Collection
{
    ...
    private function joinAdvancedCustomerEntityTable()
    {
        $this->getSelect()->joinLeft(
            ['company_customer' => $this->getTable(InstallSchema::ADVANCED_CUSTOMER_ENTITY_TABLE_NAME)],
    ...
    {
        $this->getSelect()->joinLeft(
            ['company' => $this->getTable(InstallSchema::COMPANY_TABLE_NAME)],
    ...
    {
        $this->getSelect()->joinLeft(
            ['user_role' => $this->getTable(InstallSchema::USER_ROLES_TABLE_NAME)],
    ...
    {
        $this->getSelect()->joinLeft(
            ['role' => $this->getTable(InstallSchema::ROLES_TABLE_NAME)],
