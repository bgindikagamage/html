...
class DataProviderPluginTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Magento\Customer\Model\Customer\DataProvider|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp()
    {
        ...
        $this->customerDataProvider = $this->createMock(
        ...
        $this->customerDataProviderPlugin = $objectManagerHelper->getObject(
            \Magento\Company\Plugin\Customer\Model\Customer\DataProviderPlugin::class,
            [
