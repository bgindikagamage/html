...
class RequiredFieldsTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecuteWithErrors()
    {
        ...
        $this->exception->expects($this->exactly(9))->method('addError')->withConsecutive(
            __('%fieldName is a required field.', ['fieldName' => CompanyInterface::NAME]),
            __('%fieldName is a required field.', ['fieldName' => CompanyInterface::COMPANY_EMAIL]),
            __('%fieldName is a required field.', ['fieldName' => CompanyInterface::STREET]),
            __('%fieldName is a required field.', ['fieldName' => CompanyInterface::CITY]),
            __('%fieldName is a required field.', ['fieldName' => CompanyInterface::POSTCODE]),
            __('%fieldName is a required field.', ['fieldName' => CompanyInterface::TELEPHONE]),
            __('%fieldName is a required field.', ['fieldName' => CompanyInterface::COUNTRY_ID]),
            __('%fieldName is a required field.', ['fieldName' => CompanyInterface::SUPER_USER_ID]),
            __('%fieldName is a required field.', ['fieldName' => CompanyInterface::CUSTOMER_GROUP_ID])
        )->willReturnSelf();
        $this->requiredFields->execute();
    }
}
