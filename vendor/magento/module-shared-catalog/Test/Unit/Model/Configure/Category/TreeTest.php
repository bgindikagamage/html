...
class TreeTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @param \PHPUnit_Framework_MockObject_Matcher_InvokedCount $counter
     * @return void
    ...
    public function testGetCategoryRootNode($storeId, $categoryId, $counter)
    {
        ...
        $storeGroup->expects($this->once())->method('getId')->willReturn($storeId);
        ...
        $this->assertSame($node, $this->model->getCategoryRootNode($storeGroup, $this->wizardStorage));
    }
