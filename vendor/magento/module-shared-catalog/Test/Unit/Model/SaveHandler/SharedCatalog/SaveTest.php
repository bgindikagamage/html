...
class SaveTest extends \PHPUnit\Framework\TestCase
{
    ...
    private function prepareSharedCatalogMockForPrepareTest()
    {
        ...
        $this->customerGroupManagementMock->expects($this->atLeastOnce())->method('getSharedCatalogGroupIds')
            ->willReturn([$customerGroupId]);
        $this->catalogPermissionManagementMock->expects($this->atLeastOnce())->method('reassignForRootCategories')
            ->with([$customerGroupId], $sharedCatalog);
