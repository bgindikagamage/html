...
class ProductManagementTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAssignProducts()
    {
        ...
        $sharedCatalogType = \Magento\SharedCatalog\Api\Data\SharedCatalogInterface::TYPE_PUBLIC;
     ...
     * @return void
     */
    public function testUpdateProductSharedCatalogs()
    {
        $sku = 'FGJFG4554';
        $sharedCatalogId = 435;
        ...
        $this->sharedCatalogProductItemManagement->expects($this->once())->method('saveItem');
