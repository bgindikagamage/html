...
class Permission extends \Magento\Framework\Model\AbstractModel implements PermissionInterface
{
    ...
    {
        return $this->getData(self::SHARED_CATALOG_PERMISSION_ID);
    }
    ...
    {
        return $this->getData(self::SHARED_CATALOG_PERMISSION_CATEGORY_ID);
    }
    ...
    {
        return $this->getData(self::SHARED_CATALOG_PERMISSION_WEBSITE_ID);
    }
    ...
    {
        return $this->getData(self::SHARED_CATALOG_PERMISSION_CUSTOMER_GROUP_ID);
    }
    ...
    {
        return $this->getData(self::SHARED_CATALOG_PERMISSION_PERMISSION);
    }
