...
class CopyIndex
{
     ...
     * @param array $tables
     */
    public function copy(GroupInterface $group, array $tables)
    {
        foreach ($tables as $table) {
            $this->copyIndexForTable($group->getId(), $table);
        }
    }
     ...
     * @return void
     */
    private function copyIndexForTable($newGroupId, $indexTableName)
    {
