...
class AddTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecuteWithNotConfiguredProduct()
    {
        ...
        $this->requisitionListProduct->expects($this->once())->method('getProduct')->with($sku)
            ->willReturn($product);
        $this->requisitionListProduct->expects($this->once())
            ->method('isProductShouldBeConfigured')->with($product)->willReturn(true);
    ...
    public function testExecuteWithExceptionAndEmptyItemId()
    {
        ...
        $this->requisitionListProduct->expects($this->once())
            ->method('isProductShouldBeConfigured')->with($product)->willReturn(false);
